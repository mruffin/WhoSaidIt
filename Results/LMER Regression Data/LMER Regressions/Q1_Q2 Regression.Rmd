...
response.model = glmer(C1Eng ~ HasProfile + (1|Con1Subject) , family=binomial, data) #+ (1|Con1Tweet)
...
response.model = glmer(C2Eng  ~ HasProfile + (1|Con2Subject) , family=binomial, data) #+ (1|Con2Tweet)
...
response.model = glmer(C3Eng  ~ HasProfile + (1|Con3Subject), family=binomial ,data) #+(1|Con3Tweet) 
